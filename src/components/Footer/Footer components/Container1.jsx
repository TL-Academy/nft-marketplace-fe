const Container1 = () => {
    return (
        <div className="flex justify-between items-start px-4 pb-9 lg:px-20">
            <form className="w-full lg:w-1/2">
                <h2 className="text-2xl font-bold">Stay in the loop</h2>
                <p className="w-96 lg:w-full pt-4">
                ...
                <div className="flex gap-4 pt-4">
                    ...
                    />
                    <button className="w-1/3 h-10 bg-blue-500 ml-2 px-2 py-1 rounded hover:bg-lightBlue-400 transform scale-110 transition duration-300">
                        Sign up
                    </button>
                </div>
            </form>
            <div className="text-center lg:w-1/3">
                ...
                <ul className="flex justify-center pt-4 space-x-8 text-4xl">
                    <li
                        className={
                            'px-2 py-1 rounded hover:bg-lightBlue-400 transform scale-110 transition duration-300'
                        }
                    >
                        <a href={''}>
